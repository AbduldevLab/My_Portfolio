...
const Home: React.FC = () => {
  return (
    <div
      // @ts-ignore
      name="home"
      className="min-h-screen w-full home"
      style={{ background: "#0a0a0f" }}
    >
      <div className="max-w-screen-lg mx-auto flex flex-col items-center justify-center min-h-screen px-6 md:flex-row gap-8 lg:gap-12 pt-20 pb-8 md:pt-0 md:pb-0">
        <div className="flex flex-col justify-center w-full md:flex-1">
          ...
          <p
            ...
            style={{ color: "#7a7a90", fontSize: "0.95rem", lineHeight: 1.75 }}
          >
            Full-stack engineer at{" "}
            <span style={{ color: "#f0f0f5", fontWeight: 500 }}>
              Northern Trust
            </span>
            , building microservices for global banking with Java, Spring Boot,
            React & Azure. Graduating with an{" "}
            <span style={{ color: "#f0f0f5", fontWeight: 500 }}>
              MSc in Artificial Intelligence (1:1)
            </span>{" "}
            from the University of Limerick — thesis on chronic disease
            prediction using longitudinal ML on the TILDA dataset, with a
            predicted grade of 75%+.
          </p>
        ...
        {/* Hero image */}
        <div className="hidden md:flex md:flex-shrink-0 justify-center">
          <img
            src={HeroImage}
